...
namespace ServiceReference1
{
    ...
    public interface IService
    {
        ...
        System.Threading.Tasks.Task<bool> ValidateAsync(string name, string password);
    }
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<ServiceReference1.IService>, ServiceReference1.IService
    {
        ...
        public System.Threading.Tasks.Task<bool> ValidateAsync(string name, string password)
        {
            return base.Channel.ValidateAsync(name, password);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:52131/Service.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
